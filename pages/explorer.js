    ...
    <div className="explorer-page">
      ...
      <div className="pt-16 px-4 lg:px-20 bg-gradient-to-b from-[#20253A] to-[#20253A]">
        <div className="text-2xl font-semibold text-gray-300 mb-8">
          OKTO VPN Decentralized VPN (ÐVPN) Network Nodes Overview
        </div>
        <div className="text-white">
          <p>
            Explore the OKTO VPN decentralized VPN network with our interactive map. View detailed information on active nodes, including their location, network performance, and status. This map provides real-time insights into the global distribution and operation of our secure and private VPN infrastructure.
          </p>
        </div>
      </div>
